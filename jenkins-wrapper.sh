...
juju ssh $unit_name "source /etc/profile.d/apps-bin-path.sh; git clone https://github.com/gnuoy/openstack-spell-tests.git; cd openstack-spell-tests; ./01-test-conjure-up.sh ${spell_branch}" && \
